...
# Font files
FONT_NAME_PATH = os.path.join(os.path.dirname(os.path.abspath(__file__)),"fonts", "ARIALBD.TTF")
FONT_ADDRESS_PATH = os.path.join(os.path.dirname(os.path.abspath(__file__)), "fonts", "ARIAL.TTF")
FONT_ROLE_PATH = os.path.join(os.path.dirname(os.path.abspath(__file__)), "fonts", "ARIAL.TTF")
